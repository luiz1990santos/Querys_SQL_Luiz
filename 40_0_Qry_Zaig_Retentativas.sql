...
SELECT 
    ...
    Nome_Cliente,  
    StatusConta, 
    rua||" "||numero_9||" "||bairro||" "||cidade||" "||estado as Endereco_Completo, 
    Email, 
    substring(Email,STRPOS(Email,'@')) as Desc_Email,
    DDD,
    Telefone, 
    estado||"_"||DDD as UF_DDD, 
    Dt_Abertura, 
    Safra_Abertura, 
    Faixa_Idade, 
    Flag_TempodeConta, 
...
WHERE
  ...
  and date(ult.data_cadastro) >= CURRENT_DATE() - 30
