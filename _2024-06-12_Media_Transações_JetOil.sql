...
where o.sales_channel = 'APP_JET_OIL'
--payment_method = 'GOOGLE_PAY'
--date(o.created_at) >= '2024-05-08'
--and o.code like '%SMI%'
)

select /*Dt_Tranx,*/ /*order_status,*/ round(avg(order_value),2) as TicketMedio, min(order_value) as MenorValor, max(order_value) as MaiorValor from base_JetOil
where Dt_Tranx >= '2024-01-01'
and order_value >= 10
